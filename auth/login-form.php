...
<?php require_once '../conn/general.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <div class="container mt-2">
    <div class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div style="margin-left: 9px; margin-right: 9px;">
                <div class="alert alert-danger"><a href=""><button type="button" class="close"><span>&times;</span></button></a>&emsp;<?php echo $msg; ?></div>
              </div>
            </div>
          </div>
      ...
      <div class="fs-6"> <a href="<?= base_url('public/index.php') ?>">Kembali </a></div>
    </div>
  </div>
