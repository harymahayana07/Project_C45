<?php
	...
	function hitung_gain($kasus , $atribut , $ent_all , $kondisi1 , $kondisi2 , $kondisi3 , $kondisi4 , $kondisi5, $kondisi6 , $kondisi7){
		...
		if($kondisi3==''){
			...
			$j_bhs1 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi1");
			$jml1 = $j_mipa1 + $j_ips1 + $j_bhs1;
			// 
			$j_mipa2 = jumlah_data("$data_kasus jurusan='mipa' AND $kondisi2");
			$j_ips2 = jumlah_data("$data_kasus jurusan='ips' AND $kondisi2");
			$j_bhs2 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi2");
			$jml2 = $j_mipa2 + $j_ips2 + $j_bhs2;
			
			//hitung entropy masing-masing kondisi
			$jml_total = $jml1 + $jml2;
			$ent1 = hitung_entropy($j_mipa1, $j_ips1, $j_bhs1);
			$ent2 = hitung_entropy($j_mipa2, $j_ips2, $j_bhs2);
		...
		//untuk atribut 3 nilai atribut
			...
			$j_bhs3 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi3");
			$jml3 = $j_mipa3 + $j_ips3 + $j_bhs3;
			//hitung entropy masing-masing kondisi
			$jml_total = $jml1 + $jml2 + $jml3;
			$ent1 = hitung_entropy($j_mipa1 , $j_ips1, $j_bhs1);
			$ent2 = hitung_entropy($j_mipa2 , $j_ips2, $j_bhs2);
			$ent3 = hitung_entropy($j_mipa3 , $j_ips3, $j_bhs3);
			$gain = $ent_all - ((($jml1/$jml_total)*$ent1) + (($jml2/$jml_total)*$ent2) 
						+ (($jml3/$jml_total)*$ent3));				
		}
		//untuk atribut 4 nilai atribut
			...
			$j_bhs4 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi4");
			$jml4 = $j_mipa4 + $j_ips4 + $j_bhs4;
			//hitung entropy masing-masing kondisi
			$jml_total = $jml1 + $jml2 + $jml3 + $jml4;
			$ent1 = hitung_entropy($j_mipa1 , $j_ips1, $j_bhs1);
			$ent2 = hitung_entropy($j_mipa2 , $j_ips2, $j_bhs2);
			$ent3 = hitung_entropy($j_mipa3 , $j_ips3, $j_bhs3);
			$ent4 = hitung_entropy($j_mipa4 , $j_ips4, $j_bhs4);
			$gain = $ent_all - ((($jml1/$jml_total)*$ent1) + (($jml2/$jml_total)*$ent2)
		...
		//untuk atribut 5 nilai atribut	
			...
			$j_bhs5 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi5");
			$jml5 = $j_mipa5 + $j_ips5 + $j_bhs5;
			...
			$ent3 = hitung_entropy($j_mipa3 , $j_ips3, $j_bhs3);
			$ent4 = hitung_entropy($j_mipa4 , $j_ips4, $j_bhs4);
			$ent5 = hitung_entropy($j_mipa5 , $j_ips5, $j_bhs5);
			$gain = $ent_all - ((($jml1/$jml_total)*$ent1) + (($jml2/$jml_total)*$ent2) 
	...
	$j_bhs6 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi6");
	$jml6 = $j_mipa6 + $j_ips6 + $j_bhs6;
	...
	$ent4 = hitung_entropy($j_mipa4 , $j_ips4, $j_bhs4);
	$ent5 = hitung_entropy($j_mipa5 , $j_ips5, $j_bhs5);
	$ent6 = hitung_entropy($j_mipa6 , $j_ips6, $j_bhs6);
	$gain = $ent_all - ((($jml1/$jml_total)*$ent1) + (($jml2/$jml_total)*$ent2) 
...
// untuk atribut nilai 7 atribut
	...
	$j_bhs7 = jumlah_data("$data_kasus jurusan='bhs' AND $kondisi7");
	$jml7 = $j_mipa7 + $j_ips7 + $j_bhs7;
	...
	$ent5 = hitung_entropy($j_mipa5 , $j_ips5, $j_bhs5);
	$ent6 = hitung_entropy($j_mipa6 , $j_ips6, $j_bhs6);
	$ent7 = hitung_entropy($j_mipa7 , $j_ips7, $j_bhs7);
	$gain = $ent_all - ((($jml1/$jml_total)*$ent1) + (($jml2/$jml_total)*$ent2) 
